...
const FeaturesSection = ({ theme, themeColors }) => {
  return (
    <section id="features" className={`py-16 ${themeColors[theme].background} relative`}>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-full h-16" style={{ transform: 'scaleY(-1)' }}>
          <path d="M1200 120L0 16.48V0h1200v120z" className={`fill-current ${themeColors[theme].accent}`}></path>
        </svg>
      </div>
    </section>
  );
