  ...
  return (
    <div className="min-h-screen bg-green-50 text-gray-800">
      ...
      <section id="home" className="py-20 relative overflow-hidden">
        <div className="container mx-auto text-center relative z-10">
          ...
          <motion.p
            ...
            className="pb-4 text-xl mb-8 text-green-100"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-12">
            {[
              ...
              <motion.div
                ...
                className="bg-green-50 rounded-lg p-6 text-center shadow-lg hover:shadow-xl transition-shadow duration-300"
              >
                {feature.icon}
      ...
      <section id="how-it-works" className="py-16 bg-green-100 relative">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden transform rotate-180">
          <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-full h-16">
            <path d="M1200 120L0 16.48V0h1200v120z" className="fill-current text-white"></path>
          </svg>
        </div>
      </section>
      ...
      <section className="pt-16 pb-32 bg-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden">
          <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-full h-16">
            <path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" className="fill-current text-green-600"></path>
          </svg>
        </div>
      </section>
      ...
      <section className="py-16 bg-white relative">
        <div className="container mx-auto">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="max-w-md mx-auto bg-green-50 rounded-lg p-8 shadow-lg"
          >
            <Contact />
          </motion.div>
        </div>
